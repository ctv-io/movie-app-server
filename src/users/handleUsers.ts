...
const handleUsers = {
	handleDisconnect: ({ socket, users, server }: HandleDisconnect) => {
	...
	handleReconnect: ({ socket, users, callback }: HandleUsers) => {
	...
	handleGenerateNewUser: ({ socket, users, callback }: HandleUsers) => {
